...
mlflow.set_tracking_uri('https://dagshub.com/Pronomuos/ModelCompression.mlflow')

for amount in [0.05, 0.1, 0.2, 0.5]:
    for pruning_method in [prune.L1Unstructured, prune.RandomUnstructured]:
        with mlflow.start_run(run_name="pruning") as run:
            ...
            mlflow.log_param("compression_type", "global pruning")
